...
a = Label(os2,text="User_id", width=35, background="grey",font="bold").place(relx=0.37,rely=0.38)
Entry(os2,textvariable=a1).place(relx=0.47,rely=0.38,width=150)
b = Label(os2,text="Password", width=35, background="grey",font="bold").place(relx=0.37,rely=0.45)
...
d = Button(os2, text="SUBMIT", command=lgn)
