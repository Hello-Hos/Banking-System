...
a1=StringVar()
b1=StringVar()
head1=Label(os2,text="   LOGIN FORM", background="RED", font="algerian 35", foreground="BLUE",width=12)          #(Harrington,Jokerman,Magneto,Comics,Italics)
