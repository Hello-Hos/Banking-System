...
def hk():
    ...
    mycon.commit()
    call(["python", "payment mode.py"])
label1=Label(os,text="Registration form",background="RED",width="17",font="algerian 35",foreground="BLUE")
...
bu2 =Button(os,text="Submit",command=hk,width="20")
...
label1.grid(row=0,column=1,pady=0,padx=16)
...
bu2.place(relx=0.50,rely=0.82,height=30)
